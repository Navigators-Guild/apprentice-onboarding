...
- Write Project Architecture chapter on multi-file projects and managing complexity (#10)
...
- Define jargon on first use: VDD, IAR, CLI, PR, MCP, MSRV (#39)
- Clarify Windows Rust install path and build tools (#38)
- Document crates.io account setup for cargo publish (#37)
- Add GitHub Actions/CI primer before Phase 3 Shipping chapter (#36)
- Teach environment variables and API keys before Phase 3 APIs (#35)
- Add JSON primer before first JSON reference in Phase 2 (#34)
- Add browser developer tools mini-guide for debugging (#32)
- Document how to submit work for adversarial review (#31)
- Bridge git branching/PR gap before Phase 3 Workshop (#29)
- Add Node.js/npm install to Phase 0 workspace setup (#28)
- Teach basic file operations in VS Code before Phase 1 (#27)
- Walk novice through first git push authentication (#26)
- Define the guild: where it lives and how to reach it (#25)
